...
-- Wed 21 Nov 2018 02:13:37 PM +07
...
-- Schema intern-hub
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `intern-hub` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`categories` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`users` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`recruiters` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`jobs` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`job_category` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`knex_migrations` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`knex_migrations_lock` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`skills` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`students` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `intern-hub`.`student_skill` ;
